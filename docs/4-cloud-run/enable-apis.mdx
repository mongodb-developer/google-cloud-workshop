...
Cloud Shell is a command-line environment running Google Cloud. We’ll be using Cloud Shell to enable Cloud APIs we need for the application deployment.
...
To deploy our web application, we need its source code. We will use git to fetch the [public Github repository](https://github.com/mongodb-developer/Google-Cloud-MongoDB-Atlas-Workshop).


1. Run the following command inside the Cloud Shell:
