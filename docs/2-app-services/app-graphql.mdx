...
1. There are a set of providers available for App Services. For this application, you will use the **API Keys** provider. Select it from the list, and switch it on. Before generating the key, make sure to deploy the draft.
